...
class MixSingleImageDataset(Dataset):
    def __init__(self, args, tokenizer, split, transform=None):
        self.image_dir = {'iu_xray': '/root/autodl-fs/iu_xray/iu_xray/images/',
                          'mimic_cxr': '/root/autodl-tmp/mimic_cxr/images/'}
        self.ann_path = {'iu_xray': "/root/autodl-fs/iu_xray/iu_xray/annotation.json",
